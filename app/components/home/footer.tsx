          ...
          <div className='flex flex-row gap-10'>
            ...
            <div>
              ...
              <div className='space-x-2 flex '>
                <a href='#' className='p-2 hidden md:flex'> <FaInstagram size={35}/> </a>
                <a href='#' className='p-2 hidden md:flex'> <FaLinkedin size={35} /> </a>
                <a href='#' className='p-2 hidden md:flex'> <ImGithub size={35} /> </a>
              </div>
            </div>
          </div>
          <div className='ml-4 md:ml-0'>
